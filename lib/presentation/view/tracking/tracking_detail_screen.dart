...
class _TrackingDetailScreenState extends State<TrackingDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final isPremium = context.watch<UserProvider>().userResponse?.data.isPremium ?? false;
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 12.h),
                  _buildInfoRow("Description", task?.toList().first.description),
                  SizedBox(height: 12.h),
                  _buildInfoRow("Category", task?.toList().first.category),
                  SizedBox(height: 12.h),
                  _buildInfoRow(
                    "Recommended Interval",
                    task?.toList().first.recommendedInterval,
                  ),
                  SizedBox(height: 12.h),
                  _buildInfoRow(
                    "Last Service Assumption",
                    task?.toList().first.lastServiceAssumption,
                  ),
                  SizedBox(height: 12.h),
                  _buildInfoRow(
                    "Next Due Mileage",
                    task?.toList().first.nextDueMileage,
                  ),
                  SizedBox(height: 12.h),
                  _buildInfoRow("Priority", task?.toList().first.priority),
                  SizedBox(height: 12.h),
                  Divider(color: Colors.grey.shade400, height: 1, thickness: 1),
                  SizedBox(height: 12.h),
                  if (!isPremium)
  ...
  RichText _buildInfoRow(String label, String? value) {
